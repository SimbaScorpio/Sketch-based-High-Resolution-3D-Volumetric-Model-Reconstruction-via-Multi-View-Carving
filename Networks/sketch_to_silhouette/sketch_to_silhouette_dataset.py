...
class SketchToSilhouetteDataset(Dataset):
	def __init__(self, list_file, sketch_path, silhouette_path):
	...
	def __getitem__(self, idx):
		...
		# silhouette value normalize to [-1, 1]
		# silhouettes = (silhouettes - 0.5)*2
